...
export function MapPage({ userRole, onSelectVehicle, hideNearby }: { userRole?: "student" | "driver" | "", onSelectVehicle?: (v: any) => void, hideNearby?: boolean }) {
  ...
  const vehicles = [
    {
      ...
      plate: "ILY 143",
      type: "regular",
      position: [13.7573, 121.0593] as [number, number],
    ...
    },
    {
      ...
      plate: "EJP 202",
      type: "electric",
      position: [13.7553, 121.0613] as [number, number],
    ...
    },
    {
      ...
      plate: "EJP 303",
      type: "electric",
      position: [13.7593, 121.0573] as [number, number],
